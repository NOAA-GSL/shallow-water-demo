program Test_Shallow_Water_Geometry_Config_NLUnit
  ...
  ! Shallow water geometry config object
  ...
  config = shallow_water_geometry_config_type(nl_unit)
...
end program Test_Shallow_Water_Geometry_Config_NLUnit
