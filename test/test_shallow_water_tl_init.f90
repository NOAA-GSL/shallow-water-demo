program Test_Shallow_Water_TL_Init
  ...
  use Shallow_Water_Model,           only : shallow_water_tl_type
  ...
  type(shallow_water_tl_type)              :: model
  ...
  ! Create a shallow water model geometry
  ...
  model = shallow_water_tl_type(model_config, geometry)
...
end program Test_Shallow_Water_TL_Init
