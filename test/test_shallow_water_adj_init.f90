program Test_Shallow_Water_ADJ_Init
  ...
  use Shallow_Water_Model,           only : shallow_water_adj_type
  ...
  type(shallow_water_adj_type)             :: model
  ...
  ! Initialize a shallow water model geometry
  ...
  model = shallow_water_adj_type(model_config, geometry)
...
end program Test_Shallow_Water_ADJ_Init
